            ...
            <section className="quiz quiz-small">
                <form className="setup-form">
                    ...
                    <div className="form-control">
                        ...
                        <select  name="category" id="category" onChange={handleChange} value={quiz.category} className="form-input">
                    ...
                    <div className="form-control">
                        ...
                        <select name="difficulty" id="difficulty" onChange={handleChange} className="form-input" value={quiz.difficulty}>
